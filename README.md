...
*   **ปลดล็อกปัญหาการ Login ข้ามแอป:** แก้ไขระบบให้รองรับการใช้งานผ่าน LINE บน iOS และ Android ได้อย่างไร้รอยต่อ หมดปัญหาเรื่องเบราว์เซอร์บล็อกการติดตามข้ามไซต์ (Cross-site tracking)
*   **อัปเกรดระบบแสดงผลแผนที่และ UI:** อัปเดตหน้า Dashboard ให้แสดงผลแผนที่พิกัดต้นไม้ได้แม่นยำ พร้อมแก้ปัญหากลไกการคลิกปุ่มต่างๆ ในตารางข้อมูลให้ลื่นไหล 
*   **ปรับปรุงการเชื่อมต่อฐานข้อมูลและ LINE:** ป้องกันการบันทึกข้อมูลซ้ำซ้อน (Double-submit) และแก้ไข Rich Menu ให้แสดงผลถูกต้องตามสถานะของผู้ใช้งาน (เจ้าของสวน/คนสวน) อย่างแม่นยำ
